...
<div class="auth-item-form">
    ...
    <?php $form->field($model, 'rule_name')->dropDownList($this->context->getRules(),['value'=>empty($model->ruleName)?'':array_flip($this->context->getRules())[$model->ruleName->name],'prompt'=>'请选择','maxlength' => true]) ?>
